...
def _unfold_mime_header_value(raw_value: str) -> str:
  ...
  For structured parameters (semicolon-separated key=value), the folding
  whitespace is never part of the value content, so we collapse all runs
  of SP/HTAB that appear after unfolding into nothing.
  """
